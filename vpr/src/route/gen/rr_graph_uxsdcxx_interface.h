...
class RrGraphBase {
  public:
     ...
     *   <xs:attribute name="dnode" type="xs:int" use="required" />
     *   <xs:attribute name="switch_id" type="xs:unsignedInt" use="required" />
     * </xs:complexType>
     */
    virtual inline int get_edge_dnode(typename ContextTypes::EdgeReadContext& ctx) = 0;
    ...
    virtual inline typename ContextTypes::EdgeWriteContext add_rr_edges_edge(typename ContextTypes::RrEdgesWriteContext& ctx, int dnode, unsigned int switch_id) = 0;
