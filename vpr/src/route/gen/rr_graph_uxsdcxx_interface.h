...
public:
	...
	*/
	...
	virtual inline typename ContextTypes::NodeLocWriteContext init_node_loc(typename ContextTypes::NodeWriteContext &ctx, int ptc) = 0;
	...
	*/
	...
	virtual inline enum_loc_side get_node_data_side(typename ContextTypes::NodeDataReadContext &ctx) = 0;
	virtual inline void set_node_data_side(enum_loc_side side, typename ContextTypes::NodeDataWriteContext &ctx) = 0;
	...
	*/
	...
	virtual inline typename ContextTypes::RcDataWriteContext add_rr_rc_data_rc_data(typename ContextTypes::RrRcDataWriteContext &ctx, float C, float R) = 0;
