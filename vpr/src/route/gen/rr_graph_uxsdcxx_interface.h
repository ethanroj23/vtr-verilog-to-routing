...
using ChannelReadContext = void *;
	...
	using DnodeReadContext = void *;
	using SharedDnodesReadContext = void *;
	using SSwitchReadContext = void *;
	using SharedSwitchesReadContext = void *;
...
using ChannelWriteContext = void *;
	...
	using DnodeWriteContext = void *;
	using SharedDnodesWriteContext = void *;
	using SSwitchWriteContext = void *;
	using SharedSwitchesWriteContext = void *;
...
public:
	...
	*/
	 ...
	 *   <xs:attribute name="d_idx" type="xs:unsignedInt" use="required" />
	 *   <xs:attribute name="s_idx" type="xs:unsignedInt" use="required" />
	...
	*/
	...
	virtual inline unsigned int get_node_d_idx(typename ContextTypes::NodeReadContext &ctx) = 0;
	...
	virtual inline unsigned int get_node_s_idx(typename ContextTypes::NodeReadContext &ctx) = 0;
	...
	*/
	...
	virtual inline typename ContextTypes::NodeWriteContext add_rr_nodes_node(typename ContextTypes::RrNodesWriteContext &ctx, unsigned int capacity, unsigned int d_idx, unsigned int id, unsigned int s_idx, enum_node_type type) = 0;
	...
	/** Generated for complex type "dnode":
	 * <xs:complexType name="dnode">
	 *   <xs:attribute name="val" type="xs:int" use="required" />
	 * </xs:complexType>
	*/
	virtual inline int get_dnode_val(typename ContextTypes::DnodeReadContext &ctx) = 0;

	/** Generated for complex type "shared_dnodes":
	 * <xs:complexType name="shared_dnodes">
	 *   <xs:choice maxOccurs="unbounded">
	 *     <xs:element minOccurs="0" name="dnode" type="dnode" />
	 *   </xs:choice>
	 * </xs:complexType>
	*/
	virtual inline void preallocate_shared_dnodes_dnode(typename ContextTypes::SharedDnodesWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::DnodeWriteContext add_shared_dnodes_dnode(typename ContextTypes::SharedDnodesWriteContext &ctx, int val) = 0;
	virtual inline void finish_shared_dnodes_dnode(typename ContextTypes::DnodeWriteContext &ctx) = 0;
	virtual inline size_t num_shared_dnodes_dnode(typename ContextTypes::SharedDnodesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::DnodeReadContext get_shared_dnodes_dnode(int n, typename ContextTypes::SharedDnodesReadContext &ctx) = 0;

	/** Generated for complex type "s_switch":
	 * <xs:complexType name="s_switch"> 
	 *   <xs:attribute name="id" type="xs:unsignedInt" use="required" />
	 * </xs:complexType>
	*/
	virtual inline unsigned int get_s_switch_id(typename ContextTypes::SSwitchReadContext &ctx) = 0;

	/** Generated for complex type "shared_switches":
	 * <xs:complexType name="shared_switches">
	 *   <xs:choice maxOccurs="unbounded">
	 *     <xs:element minOccurs="0" name="s_switch" type="s_switch" />
	 *   </xs:choice>
	 * </xs:complexType>
	*/
	virtual inline void preallocate_shared_switches_s_switch(typename ContextTypes::SharedSwitchesWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::SSwitchWriteContext add_shared_switches_s_switch(typename ContextTypes::SharedSwitchesWriteContext &ctx, unsigned int id) = 0;
	virtual inline void finish_shared_switches_s_switch(typename ContextTypes::SSwitchWriteContext &ctx) = 0;
	virtual inline size_t num_shared_switches_s_switch(typename ContextTypes::SharedSwitchesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::SSwitchReadContext get_shared_switches_s_switch(int n, typename ContextTypes::SharedSwitchesReadContext &ctx) = 0;

	/** Generated for complex type "rr_edges":
	 * <xs:complexType name="rr_edges">
	 *   <xs:all>
	 *     <xs:element name="shared_dnodes" type="shared_dnodes" />
	 *     <xs:element name="shared_switches" type="shared_switches" />
	 *   </xs:all>
	 * </xs:complexType>
	*/
	virtual inline typename ContextTypes::SharedDnodesWriteContext init_rr_edges_shared_dnodes(typename ContextTypes::RrEdgesWriteContext &ctx) = 0;
	virtual inline void finish_rr_edges_shared_dnodes(typename ContextTypes::SharedDnodesWriteContext &ctx) = 0;
	virtual inline typename ContextTypes::SharedDnodesReadContext get_rr_edges_shared_dnodes(typename ContextTypes::RrEdgesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::SharedSwitchesWriteContext init_rr_edges_shared_switches(typename ContextTypes::RrEdgesWriteContext &ctx) = 0;
	virtual inline void finish_rr_edges_shared_switches(typename ContextTypes::SharedSwitchesWriteContext &ctx) = 0;
	virtual inline typename ContextTypes::SharedSwitchesReadContext get_rr_edges_shared_switches(typename ContextTypes::RrEdgesReadContext &ctx) = 0;
