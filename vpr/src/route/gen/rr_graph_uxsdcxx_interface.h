...
using ChannelReadContext = void *;
	...
	using TNodeReadContext = void *;
	using TileReadContext = void *;
	using TilesReadContext = void *;
	using EdgeReadContext = void *;
	using SharedEdgesReadContext = void *;
...
using ChannelWriteContext = void *;
	...
	using TNodeWriteContext = void *;
	using TileWriteContext = void *;
	using TilesWriteContext = void *;
	using EdgeWriteContext = void *;
	using SharedEdgesWriteContext = void *;
...
public:
	...
	*/
	...
	virtual inline typename ContextTypes::NodeWriteContext add_rr_nodes_node(typename ContextTypes::RrNodesWriteContext &ctx, unsigned int capacity, unsigned int id, unsigned int ptn_idx, enum_node_type type) = 0;
	...
	/** Generated for complex type "t_node":
	 * <xs:complexType name="t_node">
	 *   <xs:attribute name="id" type="xs:unsignedInt" use="required" />
	 * </xs:complexType>
	*/
	virtual inline unsigned int get_t_node_id(typename ContextTypes::TNodeReadContext &ctx) = 0;

	/** Generated for complex type "tile":
	 * <xs:complexType name="tile">
	 *   <xs:choice maxOccurs="unbounded">
	 *     <xs:element minOccurs="0" name="t_node" type="t_node" />
	 *   </xs:choice>
	...
	*/
	...
	/** Generated for complex type "tiles":
	 ...
	 * </xs:complexType>
	*/
	virtual inline void preallocate_tiles_tile(typename ContextTypes::TilesWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::TileWriteContext add_tiles_tile(typename ContextTypes::TilesWriteContext &ctx, unsigned int x, unsigned int y) = 0;
	virtual inline void finish_tiles_tile(typename ContextTypes::TileWriteContext &ctx) = 0;
	virtual inline size_t num_tiles_tile(typename ContextTypes::TilesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::TileReadContext get_tiles_tile(int n, typename ContextTypes::TilesReadContext &ctx) = 0;
	 ...
	 *   <xs:attribute name="tile_idx" type="xs:unsignedInt" use="required" />
	 * </xs:complexType>
	*/
	virtual inline int get_edge_dx(typename ContextTypes::EdgeReadContext &ctx) = 0;
	virtual inline int get_edge_dy(typename ContextTypes::EdgeReadContext &ctx) = 0;
	virtual inline unsigned int get_edge_switch_id(typename ContextTypes::EdgeReadContext &ctx) = 0;
	virtual inline unsigned int get_edge_tile_idx(typename ContextTypes::EdgeReadContext &ctx) = 0;

	/** Generated for complex type "shared_edges":
	 * <xs:complexType name="shared_edges">
	 *   <xs:choice maxOccurs="unbounded">
	 *     <xs:element minOccurs="0" name="edge" type="edge" />
	 *   </xs:choice>
	 *   <xs:attribute name="id" type="xs:unsignedInt" use="required" />
	 * </xs:complexType>
	*/
	virtual inline unsigned int get_shared_edges_id(typename ContextTypes::SharedEdgesReadContext &ctx) = 0;
	virtual inline void preallocate_shared_edges_edge(typename ContextTypes::SharedEdgesWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::EdgeWriteContext add_shared_edges_edge(typename ContextTypes::SharedEdgesWriteContext &ctx, int dx, int dy, unsigned int switch_id, unsigned int tile_idx) = 0;
	virtual inline void finish_shared_edges_edge(typename ContextTypes::EdgeWriteContext &ctx) = 0;
	virtual inline size_t num_shared_edges_edge(typename ContextTypes::SharedEdgesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::EdgeReadContext get_shared_edges_edge(int n, typename ContextTypes::SharedEdgesReadContext &ctx) = 0;

	/** Generated for complex type "rr_edges":
	 * <xs:complexType name="rr_edges">
	 *   <xs:choice maxOccurs="unbounded">
	 *     <xs:element name="shared_edges" type="shared_edges" />
	 *   </xs:choice>
	 * </xs:complexType>
	*/
	virtual inline void preallocate_rr_edges_shared_edges(typename ContextTypes::RrEdgesWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::SharedEdgesWriteContext add_rr_edges_shared_edges(typename ContextTypes::RrEdgesWriteContext &ctx, unsigned int id) = 0;
	virtual inline void finish_rr_edges_shared_edges(typename ContextTypes::SharedEdgesWriteContext &ctx) = 0;
	virtual inline size_t num_rr_edges_shared_edges(typename ContextTypes::RrEdgesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::SharedEdgesReadContext get_rr_edges_shared_edges(int n, typename ContextTypes::RrEdgesReadContext &ctx) = 0;
	...
	*/
	...
	virtual inline typename ContextTypes::TilesWriteContext init_rr_graph_tiles(typename ContextTypes::RrGraphWriteContext &ctx) = 0;
	virtual inline void finish_rr_graph_tiles(typename ContextTypes::TilesWriteContext &ctx) = 0;
	virtual inline typename ContextTypes::TilesReadContext get_rr_graph_tiles(typename ContextTypes::RrGraphReadContext &ctx) = 0;
