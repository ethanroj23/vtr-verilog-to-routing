...
using ChannelReadContext = void *;
	...
	using RrSwitchReadContext = void *;
	using RrSwitchesReadContext = void *;
...
using ChannelWriteContext = void *;
	...
	using RrSwitchWriteContext = void *;
	using RrSwitchesWriteContext = void *;
...
public:
	...
	*/
	 ...
	 * </xs:complexType>
	*/
	virtual inline unsigned int get_rr_switch_id(typename ContextTypes::RrSwitchReadContext &ctx) = 0;
	 ...
	 * </xs:complexType>
	*/
	virtual inline void preallocate_rr_switches_rr_switch(typename ContextTypes::RrSwitchesWriteContext &ctx, size_t size) = 0;
	virtual inline typename ContextTypes::RrSwitchWriteContext add_rr_switches_rr_switch(typename ContextTypes::RrSwitchesWriteContext &ctx, unsigned int id) = 0;
	virtual inline void finish_rr_switches_rr_switch(typename ContextTypes::RrSwitchWriteContext &ctx) = 0;
	virtual inline size_t num_rr_switches_rr_switch(typename ContextTypes::RrSwitchesReadContext &ctx) = 0;
	virtual inline typename ContextTypes::RrSwitchReadContext get_rr_switches_rr_switch(int n, typename ContextTypes::RrSwitchesReadContext &ctx) = 0;
	...
	*/
	...
	virtual inline typename ContextTypes::NodeWriteContext add_rr_nodes_node(typename ContextTypes::RrNodesWriteContext &ctx, unsigned int capacity, unsigned int id, unsigned int s_idx, enum_node_type type) = 0;
	...
	*/
	...
	virtual inline typename ContextTypes::EdgeWriteContext add_rr_edges_edge(typename ContextTypes::RrEdgesWriteContext &ctx, unsigned int sink_node, unsigned int src_node) = 0;
	 ...
	 *       <xs:element name="rr_switches" type="rr_switches" />
	...
	*/
	...
	virtual inline typename ContextTypes::RrSwitchesWriteContext init_rr_graph_rr_switches(typename ContextTypes::RrGraphWriteContext &ctx) = 0;
	virtual inline void finish_rr_graph_rr_switches(typename ContextTypes::RrSwitchesWriteContext &ctx) = 0;
	virtual inline typename ContextTypes::RrSwitchesReadContext get_rr_graph_rr_switches(typename ContextTypes::RrGraphReadContext &ctx) = 0;
