...
static bool check_adjacent(int from_node, int to_node) {
    ...
    from_xhigh = rr_graph.node_xhigh_ptn(from_rr, from_rr_ptn);
    from_yhigh = rr_graph.node_yhigh_ptn(from_rr, from_rr_ptn);
    ...
    to_xhigh = rr_graph.node_xhigh_ptn(to_rr, to_rr_ptn);
    to_yhigh = rr_graph.node_yhigh_ptn(to_rr, to_rr_ptn);
