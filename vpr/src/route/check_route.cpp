...
static void check_sink(int inode, int net_pin_index, ClusterNetId net_id, bool* pin_done) {
    ...
    VTR_ASSERT(device_ctx.rr_graph.node_type(RRNodeId(inode)) /*ESR API*/ == SINK);
...
static bool check_adjacent(int from_node, int to_node) {
    ...
    from_type = device_ctx.rr_graph.node_type(RRNodeId(from_node)) /*ESR API*/;
...
static int chanx_chany_adjacent(int chanx_node, int chany_node) {
    ...
    chanx_xhigh = device_ctx.rr_graph.node_xhigh(RRNodeId(chanx_node)) /*ESR API*/;
    ...
    chany_yhigh = device_ctx.rr_graph.yhigh(RRNodeId(chany_node)) /*ESR API*/;
...
bool StubFinder::RecurseTree(t_rt_node* rt_root) {
    ...
    if (rt_root->u.child_list == nullptr) {
        ...
        if (device_ctx.rr_graph.node_type(RRNodeId(rt_root->inode)) /*ESR API*/ != SINK) {
