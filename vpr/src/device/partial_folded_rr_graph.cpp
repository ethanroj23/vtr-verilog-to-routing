...
PartialFoldedRRGraph::PartialFoldedRRGraph(const t_rr_graph_storage& node_storage) : node_storage_(node_storage){
...
read_file_2.close();
  ...
  float PartialFoldedRRGraph::node_C(RRNodeId node) const {
  ...
  float PartialFoldedRRGraph::node_R(RRNodeId node) const {
...
void PartialFoldedRRGraph::initialize_folded_rr_graph(){
...
void PartialFoldedRRGraph::add_empty_pattern(){
...
void PartialFoldedRRGraph::build_folded_rr_graph(){
    vtr::ScopedStartFinishTimer timer("Build PartialFoldedRRGraph");
